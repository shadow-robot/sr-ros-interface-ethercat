...
static const char *sensor_names[SENSORS_NUM_0X20] = {"FFJ1", "FFJ2", "FFJ3",
                                                     ...
                                                     "LFJ1", "LFJ2", "LFJ3", "LFJ4",
                                                     "LFJ5",               //  [12..16] ADC readings from Little finger
                                                     "THJ1", "THJ2", "THJ3", "THJ4", "THJ5A",
                                                     "THJ5B",     //  [17..22] ADC readings from Thumb
                                                     "WRJ1A", "WRJ1B",
                                                     "WRJ2",                               //  [23..25] ADC readings from Wrist
                                                     "ACCX", "ACCY",
                                                     "ACCZ",                               //  [26..28] ADC readings from Accelerometer
                                                     "GYRX", "GYRY",
                                                     "GYRZ",                               //  [29..31] ADC readings from Gyroscope
                                                     "AN0", "AN1", "AN2",
