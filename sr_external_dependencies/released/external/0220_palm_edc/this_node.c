...
void Service_EtherCAT_Packet(void)
{
  ...
  switch (etherCAT_command_data.EDC_command)
  {
    ...
    case EDC_COMMAND_CAN_DIRECT_MODE:                                                   // CAN Bridge packet
      ...
      {
        read_ET1200_register_N(PALM_0200_ETHERCAT_CAN_BRIDGE_DATA_COMMAND_ADDRESS, ETHERCAT_CAN_BRIDGE_DATA_SIZE,
      ...
      write_ET1200_register_N(PALM_0200_ETHERCAT_CAN_BRIDGE_DATA_STATUS_ADDRESS, ETHERCAT_CAN_BRIDGE_DATA_SIZE,
...
void Platform_Init_Callback(void)
{
  ...
  write_ET1200_register_N(PALM_0200_ETHERCAT_STATUS_DATA_ADDRESS, PALM_0200_ETHERCAT_STATUS_DATA_SIZE,
