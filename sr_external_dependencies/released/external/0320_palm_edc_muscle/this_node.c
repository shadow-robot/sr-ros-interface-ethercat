...
#ifdef PALM_PCB_01
int8u palm_EDC_0300_sensor_mapping[64] = {IGNORE, IGNORE, IGNORE, IGNORE, FFJ4, THJ4, IGNORE,
                                          IGNORE,           // Channel 0
                                          ...
                                          IGNORE, IGNORE, IGNORE, IGNORE, AN3, WRJ2, THJ2,
                                          IGNORE,           // Channel 4
                                          IGNORE, IGNORE, IGNORE, IGNORE, AN2, LFJ4, IGNORE,
                                          IGNORE,           // Channel 5
                                          RFJ3, MFJ3, FFJ3, LFJ3, AN1, LFJ5, IGNORE, IGNORE,           // Channel 6
                                          IGNORE, IGNORE, IGNORE, IGNORE, WRJ1A, WRJ1B, IGNORE,
                                          IGNORE            // Channel 7
};
#endif
