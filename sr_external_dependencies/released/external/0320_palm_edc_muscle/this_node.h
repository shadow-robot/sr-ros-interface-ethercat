...
void initialise_this_node(
        void);                            // ALL setup for this node, apart from what's explicitly listed in main.c
...
void Received_Muscle_Data(FROM_MUSCLE_DATA_TYPE data_type, int8u muscle_driver_number,
