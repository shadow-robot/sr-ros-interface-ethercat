...
{
public:
  HandLibTestProtected(ros_ethercat_mechanism_model::Robot *hw)
...
public:
  ...
  HandLibTest()
  {
    hw = new ros_ethercat_mechanism_model::Robot(NULL);
...
{
public:
  TestHandLib(ros_ethercat_mechanism_model::Robot* hw)
