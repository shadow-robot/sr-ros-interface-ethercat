...
namespace shadow_robot
{
    ...
    SrRobotLib(hw)
  {
    ...
    motor_updater_ = boost::shared_ptr<generic_updater::MotorUpdater>(new generic_updater::MotorUpdater(update_rate_configs_vector, operation_mode::device_update_state::OPERATION));
