...
int SR06::initialize(hardware_interface::HardwareInterface *hw, bool allow_unprogrammed)
{
  ...
  sr_hand_lib = boost::shared_ptr<shadow_robot::SrMotorHandLib<ETHERCAT_DATA_STRUCTURE_0200_PALM_EDC_STATUS, ETHERCAT_DATA_STRUCTURE_0200_PALM_EDC_COMMAND> >(
          new shadow_robot::SrMotorHandLib<ETHERCAT_DATA_STRUCTURE_0200_PALM_EDC_STATUS, ETHERCAT_DATA_STRUCTURE_0200_PALM_EDC_COMMAND>(
...
{
  ETHERCAT_DATA_STRUCTURE_0200_PALM_EDC_STATUS *status_data = (ETHERCAT_DATA_STRUCTURE_0200_PALM_EDC_STATUS *) (
